...
class SplitCommandTest extends BaseTest {
  ...
  void regularExecutionWithSorting() throws IOException {
    ...
    final Path output1 = tempDir.resolve("regular_1.txt");
    final Path output2 = tempDir.resolve("regular_2.txt");
    final Path output3 = tempDir.resolve("regular_3.txt");
    final Path output4 = tempDir.resolve("regular_4.txt");
