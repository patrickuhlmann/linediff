...
public class Application {
  ...
  /**
   * Main entry point into the application. It determines the specified command and calls it passing
   * along the command line arguments
   *
   * @param args name of the command and the arguments of the command
   *
   * @throws Exception if there is any error when executing a command including invalid arguments
   */
